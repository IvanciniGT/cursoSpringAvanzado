package com.curso.animalitos.servicio.rest.v2;
...
import com.curso.animalitos.servicio.rest.v2.mappers.AnimalitosRestDTOMapper;
...
@RestController
@RequestMapping("/api/v2") // Prefijo para los endpoints de esta clase
